...
use crate::domain::vo::ai_hub::analytics::{
    DailyStatsVO, HourlyTrendVO, ModelStatsVO, PerformanceTrendsVO, SystemStatsVO, TopUserStatsVO,
    UserUsageStatsVO,
};
...
pub async fn get_performance_trends(
    ...
    let trends = analytics_service.get_performance_trends(days).await?;
